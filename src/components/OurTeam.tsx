...
export default function OurTeam() {
  return (
    <div id="our-team" className="w-full bg-neutral-800">
        ...
        >
          <div className="flex flex-col gap-lg pb-lg">
            ...
            <p className="text-body-sm text-neutral-100 mb-2xl">
              Hack the Galaxy is entirely run by enthusiastic volunteers from
              Simon Fraser University Computing Science students, faculty and
              staff. Throughout Hack the Galaxy, alongside technical workshops
              and industry networking, our team aims to create a space where the
              next generation is empowered to lead their own career path in
              tech.
            </p>
          </div>
