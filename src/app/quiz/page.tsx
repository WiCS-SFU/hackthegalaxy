...
export default function QuizOverlay() {
  ...
  return (
    <section className="relative min-h-full flex-1 flex items-center justify-center overflow-hidden bg-neutral-800">
      <div>
        <div
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          <div className="mt-4 mx-2 px-3xl">
            <p className="text-body-md">
              Where creativity takes orbit, your strengths naturally rise to the
              surface. Take the quiz and find out who you are when you{" "}
          ...
          <div className="z-10 mt-8 mb-3">
            <Button
              ...
              size="large"
              iconPos="none"
              className="w-[207px] justify-center"
            >
              Take the Quiz
            </Button>
          </div>
